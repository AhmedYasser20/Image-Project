...
#         # Configure grid weights for results_frame
...
#         ttk.Entry(results_frame, textvariable=self.result_text, 
#                  state='readonly', width=80).grid(row=1, column=1, padx=5, pady=5, sticky="ew")
        
#     def load_image(self, image_path, preview_label):
#         try:
#             image = Image.open(image_path)
#             # Maintain aspect ratio within 500x400 box
...
#             print('text', self.result_text.get())
